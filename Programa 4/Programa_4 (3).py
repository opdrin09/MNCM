...
import time 
from pathlib import Path # <<< 1. IMPORTA A BIBLIOTECA DE CAMINHOS
...
# <<< MODIFICADO: Usa BASE_DIR para garantir o caminho
plt.savefig(BASE_DIR / "tarefa_1_validacao_perfil.png", dpi=300)
...
try:
    # <<< MODIFICADO: Usa BASE_DIR para garantir o caminho
    ani_val.save(BASE_DIR / "tarefa_1_validacao_animacao.gif", writer='pillow', fps=20)
    print("Animação de validação salva como 'tarefa_1_validacao_animacao.gif'")
...
# <<< MODIFICADO: Usa BASE_DIR para garantir o caminho
plt.savefig(BASE_DIR / "tarefa_2_aplicacao_perfil.png", dpi=300)
...
# <<< MODIFICADO: Usa BASE_DIR para garantir o caminho
plt.savefig(BASE_DIR / "tarefa_2_aplicacao_heatmap.png", dpi=300)
...
try:
    # <<< MODIFICADO: Usa BASE_DIR para garantir o caminho
    ani.save(BASE_DIR / "tarefa_2_aplicacao_animacao.gif", writer='pillow', fps=20)
